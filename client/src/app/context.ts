...
export type JAPContextType = {
    ...
    setAllRequirements: (requirements: Requirement[]) => void,
    ...
    addCRsToPlan: (CRsToAdd: Requirement[], plan_id?: string) => void,
    removeCRsFromPlan: (CRsToRemove: Requirement[], plan_id?: string) => void,
...
export const JAPContext = createContext<JAPContextType>({
    ...
    allAssets: [],
    setAllAssets: (assets: Asset[]) => { },
    allRequirements: [],
    setAllRequirements: (requirements: Requirement[]) => { },
